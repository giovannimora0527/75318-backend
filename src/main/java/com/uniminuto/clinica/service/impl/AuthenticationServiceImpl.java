...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    @Autowired
    private AuditoriaLoginService auditoriaService;
    ...
    @Override
    @Transactional
    public AuthenticatorRs autenticar(AuthenticatorRq authenticatorRq) throws BadRequestException {
        String ipAddress = obtenerDireccionIPv4();

        // Verificar si el usuario está bloqueado
        if (auditoriaService.usuarioEstaBloqueado(authenticatorRq.getUsername())) {
            ...
            auditoriaService.registrarIntentoLogin(
        ...
        AuthenticatorRs rta = new AuthenticatorRs();
    ...
    private long obtenerTiempoRestanteBloqueo(String username) {
        ...
        if (usuarioOpt.isPresent()) {
            ...
            if (usuario.getFechaBloqueo() != null) {
                ...
                long minutosRestantes = java.time.Duration.between(ahora, usuario.getFechaBloqueo()).toMinutes();
